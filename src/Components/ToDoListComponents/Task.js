...
import {removeTask, updateTask} from "../API/ApiTasks";
import {getOperations} from "../API/ApiOperations";

export default function Task({title, description, id, status: _status, onRemoveTask}) {
